...
#   It is NOT intended for timing and security relevant IO's. 
#   Don't use it for Emergency Stops or Endstop switches!
                ...
                if cmd == "I":
                    ...
                    if value == 1:
                        if c["din.{}-invert".format(io)] == 0:
                            c["din.{}".format(io)] = 1
                            if(DEBUG):
                                print("din{}:{}".format(io,1))
                        else: 
                            c["din.{}".format(io)] = 0
                            if(DEBUG):
                                print("din{}:{}".format(io,0))
